            ...
            <div className="home__slider">
                ...
                <Slider {...settings}>
                    <div className="home__slider-item">
                        <img className="home__slider-item-img" src={movieList[0]? baseUrl.concat(movieList[0].poster_path):''} alt="" />
                        <div className="home__slider-detail">
                            <div className="home__item-img">
                                <img src={movieList[0]? baseUrl.concat(movieList[0].poster_path):''} alt="" />
                    ...
                    <div className="home__slider-item">
                        <img className="home__slider-item-img" src={movieList[0]? baseUrl.concat(movieList[1].poster_path):''} alt="" />
                    </div>
                    <div className="home__slider-item">
                        <img className="home__slider-item-img" src={movieList[0]? baseUrl.concat(movieList[2].poster_path):''} alt="" />
                    </div>
                    <div className="home__slider-item">
                        <img className="home__slider-item-img" src={movieList[0]? baseUrl.concat(movieList[3].poster_path):''} alt="" />
                    </div>
                    <div className="home__slider-item">
                        <img className="home__slider-item-img" src={movieList[0]? baseUrl.concat(movieList[4].poster_path):''} alt="" />
                    </div>
                    <div className="home__slider-item">
                        <img className="home__slider-item-img" src={movieList[0]? baseUrl.concat(movieList[5].poster_path):''} alt="" />
                    </div>
                    <div className="home__slider-item">
                        <img className="home__slider-item-img" src={movieList[0]? baseUrl.concat(movieList[6].poster_path):''} alt="" />
                    </div>
                    <div className="home__slider-item">
                        <img className="home__slider-item-img" src={movieList[0]? baseUrl.concat(movieList[6].poster_path):''} alt="" />
                    </div>
